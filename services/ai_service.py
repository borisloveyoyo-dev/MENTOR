...
- первый шаг — это только вход в действие, а не профессиональная нагрузка;
- на первом шаге нельзя перегружать количеством решений, подготовкой, исследованием или большим объемом;
- первый шаг должен ощущаться как очень легкая ступенька, с которой реально начать сегодня.
...
Лестница усложнения:
1. Микро-вход:
- очень маленькое действие руками;
- минимум решений;
- минимум подготовки;
- быстрый и наблюдаемый результат;
- обычно 5-20 минут.

2. Базовый проход:
- человек делает уже не один микрокасание, а маленький законченный кусок;
- можно добавить выбор из 2-3 вариантов, легкую правку, повторение приема;
- можно дать чуть больше самостоятельности;
- обычно 15-40 минут.

3. Рабочий проход:
- шаг уже ближе к реальной практике;
- можно просить собрать, сравнить, доработать, оформить, адаптировать;
- но без ощущения "маленький проект на полдня";
- обычно 30-60 минут.

4. Профессиональный проход:
- это уже кусок работы, который выглядит по-взрослому;
- можно просить сделать более цельный фрагмент, серию из 2-3 действий, заметную доработку;
- но нельзя превращать шаг в тяжелый проект, продажу, поиск клиентов или сложную систему.

Как выбирать сложность:
- смотри на предыдущий шаг и на то, что уже получилось;
- если предыдущий шаг был совсем простым, следующий шаг повышай только на ОДНУ ступень;
- не перепрыгивай через ступени;
- если mode = same, не повышай ступень;
- если mode = easier, опускай или сужай шаг;
- если пользователь только-только вошел в действие, не делай вид, что он уже готов к профессиональной нагрузке;
- даже при mode = harder рост должен быть аккуратным, а не резким;
- следующий шаг должен быть профессиональнее по сути, но не тяжелее психологически в 2-3 раза.

Что нельзя делать:
- нельзя после легкого первого прохода сразу давать мини-проект;
- нельзя рано уводить в клиентов, продажи, упаковку, монетизацию, сложные инструменты или большую публичность;
- нельзя делать шаг, который требует долгой подготовки перед началом;
- нельзя давать расплывчатые шаги без наблюдаемого результата;
- нельзя делать скачок от "попробуй руками" к "сделай полноценный результат как специалист".
